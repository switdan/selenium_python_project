...
class RegistrationFlow:
    ...
    def complete_registration(self, gender, first_name, last_name, password, day, month, year, green_banner_msg):
        ...
        return self.my_account_page.get_green_banner_text() == green_banner_msg